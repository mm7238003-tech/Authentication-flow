...
<section className='mt-15  mb-40'>
  ...
  <div className='w-xl  flex flex-col mx-[30%] '>
    <p className='text-[#D9176C] text-[16px] text-center font-semibold'>Welcome Back! </p>
    <form >
...
<span span  className='text-[#222222] text-[16px]  font-normal' >Don’t have an account?</span>
<Link to="/SignUp">
<span className='text-[#D9176C] text-[16px]  font-semibold  mb-10'>Sign up</span>
</Link>
</div>
